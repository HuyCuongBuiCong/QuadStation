...
public class Waypoint {
	...
	public String toString() {
		return String.valueOf(Number) + " - "
				+ String.valueOf(Lat / Math.pow(10, 7)) + "x"
				+ String.valueOf(Lon / Math.pow(10, 7)) + " A"
				+ String.valueOf(Action) + " P" + String.valueOf(Parameter)
				+ " Alt" + String.valueOf(Altitude) + " F"
				+ String.valueOf(Flag);
	}
	 ...
	 * @param navFlag
	 */
	public Waypoint(int number, int lat, int lon, int alt, int heading,
			int timeToStay, int navFlag) {
		Number = number;
		Lat = lat;
		Lon = lon;
	 ...
	 * @param navFlag
	 */
	public Waypoint(int number, LatLng latLng, int alt, int heading,
			int timeToStay, int navFlag) {
		Number = number;
