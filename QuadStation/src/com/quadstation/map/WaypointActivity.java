...
import com.quadstation.map.ComunityMap;
...
public class WaypointActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
			...
			TVMWInfo.setText(getString(R.string.GPS_latitude) + ":"
					+ format.format(SelectedLatitude / 1e6) + "\n"
					+ getString(R.string.GPS_longitude) + ":"
					+ format.format(SelectedLongitude / 1e6));
		}
		...
		if (app.Protocol == App.PROTOCOL_NAV)
			((LinearLayout) findViewById(R.id.LinearLayoutNotNav))
				...
				.setPositiveButton(getString(R.string.Yes),
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int id) {
								...
								int alt = Integer.parseInt(EditTextAltitude
										.getText().toString());
								app.mw.SendRequestMSP_SET_WP(new Waypoint(0,
										(int) (SelectedLatitude * 10),
										(int) (SelectedLongitude * 10), alt, 0,
										0, 0));
	...
	public void SetWPPositionHoldOnClick(View v) {
		...
		app.mw.SendRequestMSP_SET_WP(new Waypoint(16,
				(int) (SelectedLatitude * 10), (int) (SelectedLongitude * 10),
				alt, 0, 0, 0));
	...
	void displayWPs() {
		...
		TVData.append("WP#" + String.valueOf(app.mw.Waypoints[0].Number) + " "
				+ String.valueOf(app.mw.Waypoints[0].Lat) + "x"
				+ String.valueOf(app.mw.Waypoints[0].Lon) + " Alt:"
				+ String.valueOf(app.mw.Waypoints[0].Altitude) + " NavFlag:"
				+ String.valueOf(app.mw.Waypoints[0].NavFlag) + "\n");
		TVData.append("WP#" + String.valueOf(app.mw.Waypoints[16].Number) + " "
				+ String.valueOf(app.mw.Waypoints[16].Lat) + "x"
				+ String.valueOf(app.mw.Waypoints[16].Lon) + " Alt:"
				+ String.valueOf(app.mw.Waypoints[16].Altitude) + " NavFlag:"
				+ String.valueOf(app.mw.Waypoints[16].NavFlag) + "\n");
		...
		alert.setPositiveButton(getString(R.string.OK),
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int whichButton) {
						...
						//
						// comunityMap.send(SelectedLatitude,
		...
		alert.setPositiveButton(getString(R.string.OK),
				new DialogInterface.OnClickListener() {
					public void onClick(DialogInterface dialog, int whichButton) {
						...
						comunityMap.send(SelectedLatitude, SelectedLongitude,
								nick, descryption);
						finish();
