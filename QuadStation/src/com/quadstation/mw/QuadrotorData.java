...
import com.quadstation.helper.FileAccess;
import com.quadstation.map.Waypoint;
...
public abstract class QuadrotorData {
	...
	public String[] MultiTypeName = { "", "TRI", "QUADP", "QUADX", "BI",
			...
			"OCTOFLATX", "OCTOFLATP", "AIRPLANE", "HELI_120_CCPM",
			"HELI_90_DEG", "VTAIL4", "HEX6H", "PPM_TO_SERVO", "DUALCOPTER",
			"SINGLECOPTER" };
	...
	public String BoxNames[] = { "LEVEL", "BARO", "MAG", "CAMSTAB", "CAMTRIG",
			"ARM", "GPS HOME", "GPS HOLD", "PASSTHRU", "HEADFREE", "BEEPER" }; // compatibility
	public String PIDNames[] = { "ROLL", "PITCH", "YAW", "ALT", "Pos", "PosR",
			"NavR", "LEVEL", "MAG", "VEL" };
	...
	public float gx, gy, gz, ax, ay, az, magx, magy, magz, head, angx, angy,
	...
	public Waypoint[] Waypoints = { new Waypoint(), new Waypoint(),
			...
			new Waypoint(), new Waypoint(), new Waypoint(), new Waypoint(),
			new Waypoint(), new Waypoint(), new Waypoint(), new Waypoint(),
			new Waypoint(), new Waypoint(), new Waypoint() };
	...
	public int rcThrottle = 1500, rcRoll = 1500, rcPitch = 1500, rcYaw = 1500,
	...
	public ServoConfClass[] ServoConf = new ServoConfClass[] {
			new ServoConfClass(), new ServoConfClass(), new ServoConfClass(),
			new ServoConfClass(), new ServoConfClass(), new ServoConfClass(),
			new ServoConfClass(), new ServoConfClass() };
	...
	public abstract void SendRequestMSP_SET_MISC(int confPowerTrigger,
			int minthrottle, int maxthrottle, int mincommand, int midrc,
			float mag_decliniation, int vbatscale, float vbatlevel_warn1,
			float vbatlevel_warn2, float vbatlevel_crit);

	public abstract void SendRequestMSP_SET_PID(float confRC_RATE,
	...
	public abstract void SendRequestMSP_SET_RAW_GPS(byte GPS_FIX, byte numSat,
