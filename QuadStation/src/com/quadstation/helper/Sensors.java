...
public class Sensors implements SensorEventListener, LocationListener {
	...
	public Sensors(Context context) {
		...
		if (location != null) {
			...
			MapCurrentPosition = new LatLng(location.getLatitude(),
	...
	public LatLng getNextPredictedLocationOnlineMap() {
		if (location != null && oldLocation != null) {
			int lat = (int) ((location.getLatitude() + (location.getLatitude() - oldLocation
					.getLatitude())));
			int lon = (int) ((location.getLongitude() + (location
					.getLongitude() - oldLocation.getLongitude())));
